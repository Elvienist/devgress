...
public class StudentDeviceLogController {
    ...
    @FXML private ComboBox<String> cbDeviceFilter; // Pinalitan ang tfSearch ng ComboBox
    ...
    public void initialize() {
        ...
        setupColumns();
        loadStudentDevices(); // Dynamic na ikakarga ang mga devices ng estudyante
        loadData();
    }

    private void loadStudentDevices() {
        List<String> devicesList = new ArrayList<>();
        devicesList.add("All Devices"); // Default option para makita lahat
        ...
        try (Connection conn = DBConnection.connect();
            ...
            while (rs.next()) {
                String fullDeviceName = rs.getString("brand") + " " + rs.getString("model");
                devicesList.add(fullDeviceName);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        cbDeviceFilter.setValue("All Devices"); // I-default sa "All Devices" mode
    }
    ...
    public void handleResetFilter() {
        ...
        dpTo.setValue(current.atEndOfMonth());
        cbDirection.setValue("All");
        cbDeviceFilter.setValue("All Devices"); // I-reset pabalik sa "All Devices" mode
        loadData();
    }
    ...
    private void loadData() {
        ...
        // Pag-filter gamit ang ComboBox value (kung hindi naka- "All Devices")
